...
export default function Example() {
  ...
  return (
    <Popover className="relative bg-green">
      <div
        onMouseEnter={() => {
          setDropdown1(false);
          setDropdown2(false);
      ...
      >
        <div
          ...
          className="flex items-center justify-between  border-dark py-6 md:justify-start md:space-x-10"
        >
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              <span className="sr-only">Your Company</span>
              {/* <img className="h-8 w-auto sm:h-10" src={img} alt="" /> */}
              <Image height={120} width={180} src={img} alt="logo" />
            </a>
          </div>
          <div className="-my-2 -mr-2 md:hidden">
            <Popover.Button className="inline-flex items-center justify-center  bg-tan p-2 text-white hover:bg-lightTan hover:text-white focus:outline-none ">
                ...
                <>
                  <Popover.Button
                    ...
                    className={classNames(
                      open ? '' : 'text-white',
                      'group inline-flex items-center text-base font-medium hover:text-gray-900 group-hover:text-lightTan focus:outline-none',
                    )}
                  >
                    <span className="text-white hover:text-lightTan">
                      ADMISSIONS
                    </span>
                    <ChevronDownIcon
                      className={classNames(
                        open ? 'text-white' : 'text-white',
                        'ml-2 h-5 w-5 group-hover:text-lightTan',
                      )}
                      aria-hidden="true"
                    />
                  </Popover.Button>
                      ...
                      <div className="overflow-hidden shadow-lg ring-1 ring-black ring-opacity-5">
                        <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                          {admission.map((item) => (
                            ...
                            >
                              <item.icon
                                className="h-6 w-6 flex-shrink-0 text-green"
                                aria-hidden="true"
                              />
                              <div className="ml-4">
              ...
              {({ open }) => (
                <>
                  <Popover.Button
                    ...
                    className={classNames(
                      open ? '' : 'text-white',
                      'group inline-flex items-center text-base font-medium hover:text-lightTan focus:outline-none',
                    )}
                  >
                    <span className="text-white hover:text-lightTan">
                      GALLERY
          ...
          <div className="divide-y-2 divide-gray-50  bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            <div className="px-5 pt-5 pb-6">
              <div className="flex items-center justify-between">
                <div>
                  <Image height={80} width={140} src={img} alt="logo" />
                </div>
                <div className="-mr-2">
